...
docker build --progress plain -f ./Dockerfile-8.1-rc-debug -t jakubboucek/lamp-devstack-php:8.1-rc-debug ./
docker run --rm jakubboucek/lamp-devstack-php:8.1-rc php --version
docker run --rm jakubboucek/lamp-devstack-php:8.1-rc-debug php --version
...
docker tag jakubboucek/lamp-devstack-php:8.1-rc-debug jakubboucek/lamp-devstack-php:8.1.${PHP_RELEASE}-debug
...
docker push jakubboucek/lamp-devstack-php:8.1-rc-debug
