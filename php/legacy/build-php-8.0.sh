...
if [ "${NO_BUILD:-0}" -ne "1" ]; then
    ...
    docker tag jakubboucek/lamp-devstack-php:8.0-legacy jakubboucek/lamp-devstack-php:8-legacy
    docker tag jakubboucek/lamp-devstack-php:8.0-legacy-debug jakubboucek/lamp-devstack-php:8-legacy-debug
fi
...
if [ "${NO_PUSH:-0}" -ne "1" ]; then
    ...
    docker push jakubboucek/lamp-devstack-php:8-legacy-debug
    docker push jakubboucek/lamp-devstack-php:8.0-legacy
    docker push jakubboucek/lamp-devstack-php:8-legacy
fi
